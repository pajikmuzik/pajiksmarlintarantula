#define PRINTER_NAME "Tarantula_1.1.9"  // Change this to whatever you wish, or leave it as it is.
...
#define MOTHERBOARD BOARD_MKS_GEN_L        // Original controller board with built in stepper drivers. Works with MKS BASE 1.3, 1.4
...
#define CUSTOM_MACHINE_NAME "TarantulaMarlin1.1.9"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
//#define MACHINE_UUID "b7daf833-13e7-474e-adb8-d2f42e1610ad"
...
//#define ENDSTOPPULLUPS
  ...
  //#define ENDSTOPPULLUP_XMAX //CHANGED
...
#endif
//#define X_MAX_ENDSTOP_INVERTING true // set to true to invert the logic of the endstop. CHNAGED
